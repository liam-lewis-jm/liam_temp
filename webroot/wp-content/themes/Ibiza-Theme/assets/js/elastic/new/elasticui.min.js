        ...
        var IndexController = (function () {
            function IndexController($scope, $timeout, $window, es, $rootScope) {
                ...
                $scope.$watch('indexVM.sort', function () {
                    //_this.indexVM.page = 1; ryan update
                    _this.search();
                });
            ...
            IndexController.prototype.onResult = function (body, updateOnlyIfCountChanged) {
                ...
                if( typeof(elastic_callback) == "function" )  {
                    
                    elastic_callback(body, updateOnlyIfCountChanged);
        ...
        (function (directives) {
            ...
            var ChecklistDirective = (function () {
                function ChecklistDirective($parse) {
                    ...
                    directive.link = {
                        'pre': function (scope, element, attrs) {
                            elasticui.util.AngularTool.setupBinding($parse, scope, attrs, ["field", "size" ,"display"]);
                    ...
                    <ul class="nav nav-list" eui-aggregation="ejs.TermsAggregation(agg_name).field(field).size(size)">\
                        <li ng-repeat="bucket in aggResult.buckets">\
                            <label class="checkbox" eui-filter="ejs.TermsFilter(field, bucket.key)">\
                                <input type="checkbox" ng-model="filter.enabled" data-id="the_value_{{field}}_{{bucket.key | makeUppercase }}">\
    ...
    (function (widgets) {
        ...
        (function (directives) {
            ...
            var RangeDirective = (function () {
                function RangeDirective($parse) {
                    var directive = {};
                    directive.restrict = 'E';
                    directive.scope = true;
                    directive.link = {
                        'pre': function (scope, element, attrs) {
                            elasticui.util.AngularTool.setupBinding($parse, scope, attrs, ["field", "size" ,"min" ,"max" , "display" ]);
                            scope.agg_name = scope.field.replace(/[^a-z_0-9]/gmi, "_") + "_" + (directives.default_agg_count++);
                        }
                    };
                    // TODO: make sure checked boxes are always at top
                    directive.template = '\
                    <ul class="nav " eui-aggregation="ejs.FilterAggregation(agg_name).filter(ejs.RangeFilter(agg_name).gt(min).lt(max).field(field)) ">\
                        <li class="rst_{{aggResult.doc_count}}">\
                            <label class="checkbox" eui-filter="ejs.RangeFilter(\'price\').gt(min).lt(max)">\
                                <input type="checkbox" ng-model="filter.enabled" data-id="the_value_{{field}}_{{min}}_{{max}}">\
                                &pound;{{min}} - &pound;{{max}} ({{aggResult.doc_count}})\
                            </label>\
                        </li>\
                    </ul>';
                    return directive;
                }
                RangeDirective.$inject = ['$parse'];
                return RangeDirective;
            })();
            directives.RangeDirective = RangeDirective;
            directives.directives.directive('euiRange', RangeDirective);
        })(directives = widgets.directives || (widgets.directives = {}));
    })(widgets = elasticui.widgets || (elasticui.widgets = {}));
})(elasticui || (elasticui = {}));
var elasticui;
    ...
    (function (widgets) {
        ...
        (function (directives) {
            ...
            <ul class="pager" data-id="pager">\
                <li ng-if="indexVM.page <= 1" class="disabled"><a href=""><</a></li>\
                <li ng-if="indexVM.page > 1"><a href="" ng-click="indexVM.page=indexVM.page - 1"><</a></li>\
                <li class="page-count">Page {{indexVM.page}} of {{indexVM.pageCount}}</li>\
                <li ng-if="indexVM.pageCount <= indexVM.page" class="disabled"><a href="">></a></li>\
                <li ng-if="indexVM.pageCount > indexVM.page"><a href="" ng-click="indexVM.page=indexVM.page + 1">></a></li>\
            </ul>\
';
                    return directive;
                }
...
(function (elasticui) {
    ...
    (function (widgets) {
        ...
        (function (directives) {
            // The widgets show how to create reusable components on top of ElasticUI. 
            // You can also directly use the directive.template html in your front-end (see docs/widgets.md for more info)
            var SimplePaginationDirective = (function () {
                function SimplePaginationDirective() {
                    var directive = {};
                    directive.restrict = 'E';
                    directive.scope = true;
                    directive.template = '\
            <ul class="pager" data-id="pager">\
            <li><pagination total-items="100" page="1" items-per-page="2" max-size="4" rotate="false" num-pages="numPages" previous-text="<" next-text=">" on-select-page=""></pagination></li>\
            </ul>\
';
                    return directive;
                }
                return SimplePaginationDirective;
            })();
            directives.SimplePagingDirective = SimplePaginationDirective;
            directives.directives.directive('euiSimplePagination', SimplePaginationDirective);
        })(directives = widgets.directives || (widgets.directives = {}));
    })(widgets = elasticui.widgets || (elasticui.widgets = {}));
})(elasticui || (elasticui = {}));
var elasticui;
        ...
        (function (directives) {
            ...
            var SearchboxDirective = (function () {
                function SearchboxDirective($parse) {
                    ...
                    directive.template = '\
            <input type="text" eui-query="ejs.MatchQuery(field, querystring)" ng-model="querystring" eui-enabled="querystring.length>=4" />\
            ';
                    return directive;
                }
...
(function (elasticui) {
    ...
    (function (widgets) {
        ...
        (function (directives) {
            // The widgets show how to create reusable components on top of ElasticUI. 
            // You can also directly use the directive.template html in your front-end (see docs/widgets.md for more info)
            var SearchboxxDirective = (function () {
                function SearchboxxDirective($parse) {
                    var directive = {};
                    directive.restrict = 'E';
                    directive.scope = true;
                    directive.link = {
                    ...
                    var qIn = 'ejs.QueryStringQuery(querystring).lenient(true).fields([' + searchables + '])';
                    //console.log( qIn );
                    // TODO: should be debounced
                    directive.template = '\
            <input type="text" eui-query="' + qIn + '" ng-model="querystring" eui-enabled="querystring.length>=3" id="s-box" />\
            ';
                    return directive;
                }
                SearchboxxDirective.$inject = ['$parse'];
                return SearchboxxDirective;
            })();
            directives.SearchboxxDirective = SearchboxxDirective;
            directives.directives.directive('euiSearchboxx', SearchboxxDirective);
        })(directives = widgets.directives || (widgets.directives = {}));
    })(widgets = elasticui.widgets || (elasticui.widgets = {}));
})(elasticui || (elasticui = {}));
