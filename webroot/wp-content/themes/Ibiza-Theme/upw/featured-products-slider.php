...
<div class="upw-posts hfeed <?php echo $container_class; ?> featured-products-slider">
    ...
    <div<?php echo $swiper_data;?>>
     ...
     <div class="<?php echo $row_class; ?>">
          ...
          <?php if (current_theme_supports('post-thumbnails') && $instance['show_thumbnail'] && has_post_thumbnail()) : ?>              
            <div class="featured-products-image" style="background-image:url(<?php the_post_thumbnail_url($instance['thumb_size']); ?>);"></div>
          <?php endif; ?>
              
          <header>
            <?php if (get_the_title() && $instance['show_title']) : ?>
              <h4 class="entry-title featured-products-title">
          ...
          <?php if ($instance['show_excerpt']) : ?>
            <div class="entry-summary featured-products-price">
