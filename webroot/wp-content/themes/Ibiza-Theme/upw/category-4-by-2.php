    ...
    <div<?php echo $swiper_data;?>>
      <?php while ($upw_query->have_posts()) : $upw_query->the_post(); ?>
        ...
        <?php if (current_theme_supports('post-thumbnails') && $instance['show_thumbnail'] && has_post_thumbnail()) : ?>              
              <article <?php post_class($current_post); ?>  style="background-size:cover;background-image:url(<?php the_post_thumbnail_url($instance['thumb_size']); ?>);" >
        <?php else:?>
            ...
            <article <?php post_class($current_post); ?> style="background-size:cover;background-image:url(<?php echo $rowArrTitles[trim(get_the_title())]['image']; ?>);" >
        <?php endif; ?>    
