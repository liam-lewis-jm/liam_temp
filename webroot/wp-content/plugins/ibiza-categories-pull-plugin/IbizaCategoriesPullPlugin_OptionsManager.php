...
class IbizaCategoriesPullPlugin_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'ibiza-categories-pull-plugin'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'ibiza-categories-pull-plugin'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'ibiza-categories-pull-plugin'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'ibiza-categories-pull-plugin'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'ibiza-categories-pull-plugin');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'ibiza-categories-pull-plugin'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'ibiza-categories-pull-plugin');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'ibiza-categories-pull-plugin'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'ibiza-categories-pull-plugin') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'ibiza-categories-pull-plugin');
            case 'false':
                return __('false', 'ibiza-categories-pull-plugin');

            case 'Administrator':
                return __('Administrator', 'ibiza-categories-pull-plugin');
            case 'Editor':
                return __('Editor', 'ibiza-categories-pull-plugin');
            case 'Author':
                return __('Author', 'ibiza-categories-pull-plugin');
            case 'Contributor':
                return __('Contributor', 'ibiza-categories-pull-plugin');
            case 'Subscriber':
                return __('Subscriber', 'ibiza-categories-pull-plugin');
            case 'Anyone':
                return __('Anyone', 'ibiza-categories-pull-plugin');
        }
        return $optionValue;
    }
