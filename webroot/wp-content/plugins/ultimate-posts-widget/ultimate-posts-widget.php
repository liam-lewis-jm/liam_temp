...
if (!class_exists('WP_Widget_Ultimate_Posts')) {
    ...
    class WP_Widget_Ultimate_Posts extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                    'sticky-posts', __('Ultimate Posts', 'upw'), $widget_options, $control_options
            );
            ...
            <?php if ($instance) { ?>
                ...
                <script>
                    ...
                    jQuery(document).ready(function ($) {
                        ...
                        var show_post = $("#<?php echo $this->get_field_id('showpost'); ?>");
                        var post_type = $("#<?php echo $this->get_field_id('types'); ?>");
