...
class IbizaApi_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'ibiza-api'));
        }
        ...
        <div class="wrap">
            ...
            <tr><td><?php _e('PHP Version', 'ibiza-api'); ?></td>
                ...
                if (version_compare('5.2', phpversion()) > 0) {
                    ...
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'ibiza-api');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'ibiza-api'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'ibiza-api');
                    }
                    echo '</span>';
                    ?>
                </td>
...
<!--            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'ibiza-api'); ?></h2>-->
           ...
           <iframe width="100%" height="600px" src="http://ibizaschemas.product.uat/ProductCatalog.Web/document_edit/Tablet/5786078b1ea1f20af417c1bb/%7B%7D"></iframe>
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'ibiza-api');
            case 'false':
                return __('false', 'ibiza-api');

            case 'Administrator':
                return __('Administrator', 'ibiza-api');
            case 'Editor':
                return __('Editor', 'ibiza-api');
            case 'Author':
                return __('Author', 'ibiza-api');
            case 'Contributor':
                return __('Contributor', 'ibiza-api');
            case 'Subscriber':
                return __('Subscriber', 'ibiza-api');
            case 'Anyone':
                return __('Anyone', 'ibiza-api');
        }
        return $optionValue;
    }
