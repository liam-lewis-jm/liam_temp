...
//    }
    ...
    function create_posttype() {
        ...
        register_post_type('presenters', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
                // let's now add all the options for this post type
                array('labels' => array(
                'name' => __('Presenters', 'jointswp'), /* This is the Title of the Group */
                'singular_name' => __('Presenters', 'jointswp'), /* This is the individual type */
                'all_items' => __('All Presenters', 'jointswp'), /* the all items menu item */
                'add_new' => __('Add New', 'jointswp'), /* The add new menu item */
                'add_new_item' => __('Add New Presenters', 'jointswp'), /* Add New Display Title */
                'edit' => __('Edit', 'jointswp'), /* Edit Dialog */
                'edit_item' => __('Edit Presenter', 'jointswp'), /* Edit Display Title */
                'new_item' => __('New Presenter', 'jointswp'), /* New Display Title */
                'view_item' => __('View Presenters', 'jointswp'), /* View Display Title */
                'search_items' => __('Search Presenters', 'jointswp'), /* Search Custom Type Title */
                'not_found' => __('Nothing found in the Database.', 'jointswp'), /* This displays if there are no entries yet */
                'not_found_in_trash' => __('Nothing found in Trash', 'jointswp'), /* This displays if there is nothing in the trash */
                'parent_item_colon' => ''
            ), /* end of arrays */
            ...
            'menu_position'         => 8, /* this is what order you want it to appear in on the left hand side menu */
            'menu_icon'             => 'dashicons-book', /* the icon for the custom post type menu. uses built-in dashicons (CSS class name) */
            'rewrite'               => array('slug' => 'presenters', 'with_front' => false), /* you can specify its url slug */
            'capability_type'       => 'post',
            'hierarchical'          => false,
            'taxonomies'            => array('category'),
            /* the next one is important, it tells what's enabled in the post editor */
